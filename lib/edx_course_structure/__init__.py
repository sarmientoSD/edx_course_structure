...
def getCourseStructure(input_file, output_file=None):
    ...
    output_name = output_file if output_file else "+".join(
...
def main():
    ...
    file_exists = os.path.exists(input_name)
    if not file_exists:
    ...
    getCourseStructure(INPUT_NAME, OUTPUT_PATH)
